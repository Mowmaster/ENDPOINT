...
public class MinersDelightGenLayerBiome extends GenLayer
{
    @SuppressWarnings("unchecked")
    private java.util.List<net.minecraftforge.common.BiomeManager.BiomeEntry>[] biomes = new java.util.ArrayList[net.minecraftforge.common.BiomeManager.BiomeType.values().length];
    private final ChunkProviderSettings settings;

    public MinersDelightGenLayerBiome(long p_i45560_1_, GenLayer p_i45560_3_, WorldType p_i45560_4_, String p_i45560_5_)
    {
        super(p_i45560_1_);
        ...
        biomes[desertIdx].add(new BiomeManager.BiomeEntry(BiomeReg.MinersDelight, 10));
        ...
        if (p_i45560_4_ == WorldType.DEFAULT_1_1)
        {
            ...
            biomes[desertIdx].add(new BiomeManager.BiomeEntry(Biomes.PLAINS, 10));
            biomes[desertIdx].add(new BiomeManager.BiomeEntry(BiomeReg.MinersDelight, 400));
